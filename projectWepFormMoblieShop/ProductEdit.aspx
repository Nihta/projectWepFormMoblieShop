<%@ Page Title="Product | Edit" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="projectWepFormMoblieShop.ProductEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <div class="container-fluid m-3">
        ...
        <form id="FormProduct" class="row g-3" runat="server">
            ...
            <div class="col-12">
                <asp:Button ID="BtnEdit" runat="server" Text="Edit" OnClick="BtnEdit_Click" CssClass="btn btn-sm btn-primary me-2 px-5" />
            </div>
        </form>
    </div>
</asp:Content>
