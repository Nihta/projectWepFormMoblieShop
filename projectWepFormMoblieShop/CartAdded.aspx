<%@ Page Title="Item added" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CartAdded.aspx.cs" Inherits="projectWepFormMoblieShop.CartAdded" %>
                    ...
                    <div class="d-flex flex-row flex-md-column align-items-center">
                        <div class="mr-4 mr-md-0">
                            <div class="cart-added__img-container">
                                <img class="img-fluid"
                                    src="https://blue-bottle-cms.global.ssl.fastly.net/hbhhv9rz9/image/upload/c_thumb,h_148,w_148/v1623263878/cxchljteho0hzlguik7g.jpg"
                                    alt="*">
                        ...
                        <div class="mt-md-3">
                            ...
                            <p class="f16 fw600 mb-2">$25</p>
                            <div class="f14 mb-1">
                                QTY: 1 <a class="custom-link text-decoration-none" href="#">Change</a>
                            </div>
                        </div>
                    </div>
